 ...
 * @LastEditors: Tang
 * @LastEditTime: 2021-07-31 20:48:08
 */
...
const SystemRoleMenu = Loadable({
  loader: () =>
    import(
      /* webpackChunkName: 'SystemRoleMenu', webpackPrefetch: true */ "@/views/system/role/menu/menu"
    ),
  loading: DefineLoading,
});
...
const SystemRoleButton = Loadable({
  loader: () =>
    import(
      /* webpackChunkName: 'SystemRoleButton', webpackPrefetch: true */ "@/views/system/role/button/button"
    ),
  loading: DefineLoading,
});
...
const system = [
  ...
  },
  {
    ...
    from: "/base/system/role",
    to: "/base/system/role/menu",
    exact: true,
    redirect: true,
  },
  {
